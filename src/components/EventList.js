...
//               className="ml-3 px-3 py-1 cursor-pointer rounded-sm bg-black mb-0 mr-5 text-[17px] text-white hover:bg-sky-500 hover:text-white  transition-transform duration-300 ease-in-out transform hover:scale-105 hover:-translate-y-2 hover:shadow-sm flex flex-col items-center justify-center mt-1"
//             >
//               Home
//             </li>
//             <li
//               //   className="ml-3 px-5 py-5 mt- rounded-2xl cursor-pointer bg-white mb-4 mr-5 text-[17px] text-center hover:bg-sky-500"
//               className="ml-3 px-3 py-1 cursor-pointer rounded-sm bg-black mb-0 mr-5 text-[17px] text-white hover:bg-sky-500 hover:text-white  transition-transform duration-300 ease-in-out transform hover:scale-105 hover:-translate-y-2 hover:shadow-sm flex flex-col items-center justify-center "
//             >
//               Disvover
//             </li>
//             <li
...
//             </li>
//           </div>
//           <hr className=" ml-3 mt-2 w-[170px] mb-2" />
//           <div>
//           <div className="px-3 py-2">
//             <h1 className="text-white text-[20px] ml-1">Top Categories</h1>
//           </div>
//             <li
//               //   className="ml-3 px-5 py-5 mt- rounded-2xl cursor-pointer bg-white mb-4 mr-5 text-[17px] text-center hover:bg-sky-500"
//               className="ml-3 px-3 py- cursor-pointer rounded-sm bg-black mb-0 mr-5 text-[17px] text-white hover:bg-sky-500 hover:text-white transition-transform duration-300 ease-in-out transform hover:scale-105 hover:-translate-y-2 hover:shadow-sm flex flex-col items-center justify-center "
//             >
//               Music Events
//             </li>
//             <li
//               //   className="ml-3 px-5 py-5 mt- rounded-2xl cursor-pointer bg-white mb-4 mr-5 text-[17px] text-center hover:bg-sky-500"
//               className="ml-3 px-3 py-2 cursor-pointer rounded-sm bg-black mb-0 mr-5 text-[17px] text-white hover:bg-sky-500 hover:text-white transition-transform duration-300 ease-in-out transform hover:scale-105 hover:-translate-y-2 hover:shadow-sm flex flex-col items-center justify-center "
//             >
//               Art&Exhibitions
//             </li>
//             <li
...
//                     className="w-[370px] h-[240px] bg-gray-200 rounded-2xl shadow-md transition-transform duration-300 ease-in-out transform hover:scale-105 hover:-translate-y-2 hover:shadow-lg flex flex-col items-center justify-center"
//                     src={event.image}
//                   />
//                 </div>
  ...
  return (
    <div className="bg-black flex mt-[170px]">
      <div className="relative">
        {/* Hamburger Icon */}
        <div
          className="hamburger-icon p-4 cursor-pointer fixed top-5 left-5 z-50 bg-black text-white rounded-full"
        ...
        >
          <ul className="flex flex-col justify-between p-5">
            ...
            <div>
              ...
              <hr className=" ml-3 mt-2 w-[160px] mb-2" />
              <div>
                <div className="px-3 py-2">
                  <h1 className="text-white text-[19px] ml-2 mb-4">
                    Top Categories
                  </h1>
                </div>
                <li
